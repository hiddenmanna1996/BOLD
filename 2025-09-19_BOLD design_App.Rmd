 ...
 { #1
  ...
  if (level_a==2 & level_b==2) # 2x2 design
   ...
   # Dose selection based on loss function.
    ppat_selection <- 0.5 # The dose whose PPAT is nearest to 0.5 will be chosen.
    for (i in 1:level_a)
      { #5
       for (j in 1:level_b)
        { #6
...
n_stop_total <- c(20,25,30,35,40) # Maximum total number of treated patients.
...
ui <- bslib::page_sidebar(
  ...
  sliderInput("p_target", label="What is the target DLT rate? (Default value is 0.25)", min=0, max=1, value=0.25, step = 0.01),
...
matrixInput(
  "dlt_prior_input_1_2",
  label="Please enter the prior mean DLT rates (Default values are 0.2 and 0.4 for dose 1 and 2):",
...
matrixInput(
  "dlt_prior_input_1_3",
  label="Please enter the prior mean DLT rates (Default values are 0.2, 0.3 and 0.4 for dose 1, 2 and 3):",
...
matrixInput(
  "dlt_prior_input_1_4",
  label="Please enter the prior mean DLT rates (Default values are 0.1, 0.2, 0.3 and 0.4 for dose 1, 2, 3 and 4):",
...
matrixInput(
  "dlt_prior_input_1_5",
  label="Please enter the prior mean DLT rates (Default values are 0.1, 0.2, 0.3, 0.4 and 0.5 for dose 1, 2, 3, 4 and 5)",
...
matrixInput(
  "dlt_prior_input_2_2",
  label="Please enter the prior mean DLT rates (Default values are 0.1, 0.2, 0.2 and 0.3 for A1B1, A1B2, A2B1 and A2B2)",
...
matrixInput(
  ...
  label="Please enter the thresholds for toxicity control (Default value is 0.9 for dose 1 and 0.95 for other doses) :",
...
matrixInput(
  "x_toxic_input_1_2",
  label="Please enter the numbers of accumulated DLT's :",
...
matrixInput(
  "n_input_1_2",
  label="Please enter the accumulated numbers of treated patients :",
...
matrixInput(
  "dlt_true_input_1_2",
  label="Please enter the true DLT rates for simulation :",
